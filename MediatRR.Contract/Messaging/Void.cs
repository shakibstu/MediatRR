...
namespace MediatRR.Contract.Messaging
{
    ...
    {
        private static readonly Void InternalValue = new Void();

        /// <summary>
        /// Default and only value of the <see cref="Void"/> type.
        /// </summary>
        public static ref readonly Void Value => ref InternalValue;

        /// <summary>
        /// Task from a <see cref="Void"/> type.
        /// </summary>
        public static Task<Void> Task { get; } = System.Threading.Tasks.Task.FromResult(InternalValue);
